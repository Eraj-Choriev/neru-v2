...
The dock uses the “Colored Default, White Active” variant from
...
component are not included. Existing navigation, drag handlers and CSS
transition timing remain authoritative.
...
The blue-grey dock is deliberately darker than the light map for white labels.
